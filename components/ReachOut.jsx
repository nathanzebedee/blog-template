            ...
            <Dialog as="div" className="relative z-10" initialFocus={cancelButtonRef} onClose={setOpenContact}>
                ...
                <div className="fixed z-10 inset-x-0 inset-y-80 sm:inset-0">
                    <div className="flex items-end sm:items-center justify-center min-h-full p-4 text-center sm:p-0">
                        ...
                        >
                            <Dialog.Panel className="relative bg-gradient-to-r from-rose-100 via-pink-100 to-purple-100 rounded-xl px-4 pt-5 pb-4 text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:max-w-lg sm:w-full sm:p-6">
                                <div>
                                    <div className="mt-3 text-center sm:mt-5">
                                        <Dialog.Title as="h3" className="text-3xl font-bold tracking-wide leading-6 text-transparent bg-clip-text p-2 bg-gradient-to-r from-rose-400 via-pink-400 to-purple-400">
                                            let&#39;s get in touch!
                                        </Dialog.Title>
                                        <div className="mt-2">
